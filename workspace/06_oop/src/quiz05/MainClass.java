...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		me.transfer(you,-100);	// -100원 이체 불가능
		me.transfer(you, 7000);	// 7000원 이체 불가능
		
		
		
		// 입금
		// me.deposit(10000); // 10000원 입금
		// me.deposit(-1000); // 마이너스 입금은 불가능
		
		// 출금
		// you.withdraw(5000); // 5000원 출금
		// you.withdraw(-100); // 마이너스 출금은 불가능
		// you.withdraw(7000); // 잔고 부족으로 불가능
