	...
	public static void main(String[] args) {
		...
		try {
			...
			while ((line = br.readLine()) != null) {
				// line : <a
				// href="https://search.daum.net/search?w=tot&amp;q=%EC%9C%A4%EC%84%B8%EC%95%84+%EC%B6%9C%EC%97%B0%ED%99%95%EC%A0%95&amp;DA=NPI&amp;rtmaxcoll=NNS"class="link_favorsch @6">윤세아 출연확정</a>
				// 이와 같이 "link_favorsch"만 포함된 line이 필요하다.
