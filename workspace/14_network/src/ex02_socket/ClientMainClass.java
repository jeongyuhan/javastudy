...
public class ClientMainClass {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// client.connect(new InetSocketAddress(InetAddress.getByName("localhost"), 4966));
			...
			String message = new String(b, 0, length, "UTF-8"); // byte로 받아온 message를 new String()을 이용해서 String으로 바꿔준다.
