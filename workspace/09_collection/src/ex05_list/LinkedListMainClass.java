...
/*
	...
	3. 연결리스트를 구현한 클래스이다. 자동으로 길이를 조정한다.
...
public class LinkedListMainClass {
	...
	public static void main(String[] args) {
		...
		// ArrayList와 LinkedList의 사용법은 같다.
		
		// 성능 비교(ArrayList vs LinkedList)
		...
		System.out.println("ArrayList 추가 소요시간 : " + (end1 - start1) + "ns");
		...
		System.out.println("LinkedList 추가 소요시간 : " + (end2 - start2) + "ns");
